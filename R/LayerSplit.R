...
#' @param qua A dataframe from the Quantify function
...
#' @return The original qua dataframe including an Exp variable, with a unique name for each image (based on the naming given in the Quantify function). And a Split varaible denoting the split
#' @export

LayerSplit <- function(qua,side,pt,add.t,add.b,channel=NULL,trim=FALSE,layer.start=NULL){
